...
// Type: Geex.Play.Rpg.Custom.Battle.Rules.RulesNpc
...
{
  public class RulesNpc : RulesBattler
  {
    private int troopId;
    ...
    public string Name => Data.Npcs[this.npcId].Name;
    ...
    public RulesNpc(int troop_id, int member_index)
    {
    ...
    {
      get => PositionManager.GetInstance().Scene.Spriteset.EnemySprites[this.Index].X;
    }

    public override int ScreenY
    {
      get => PositionManager.GetInstance().Scene.Spriteset.EnemySprites[this.Index].Y;
    }

    public override int ScreenZ => 120 + this.memberIndex;
  }
}
